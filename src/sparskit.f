...
c    ----------------------------------------------------------------------- 
c    
c    Latest update : Tue Mar  8 11:01:12 CST 2005
c    
c    -----------------------------------------------------------------------
c    
c    Welcome  to SPARSKIT  VERSION  2.  SPARSKIT is  a  package of  FORTRAN
c    subroutines  for working  with  sparse matrices.  It includes  general
c    sparse  matrix  manipulation  routines  as  well as  a  few  iterative
c    solvers, see detailed description of contents below.
c    
c     Copyright (C) 2005, the Regents of the University of Minnesota 
c    
c    SPARSKIT is  free software; you  can redistribute it and/or  modify it
c    under the terms of the  GNU Lesser General Public License as published
c    by the  Free Software Foundation [version  2.1 of the  License, or any
c    later version.]
c    
c    
c    A copy of  the licencing agreement is attached in  the file LGPL.  For
c    additional information  contact the Free Software  Foundation Inc., 59
c    Temple Place - Suite 330, Boston, MA 02111, USA or visit the web-site
c     
